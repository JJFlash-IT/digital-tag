...
tPlayer_x! = 1 : tPlayer_y! = 1 : print "{CLR}" : print @mazebin![0] : poke 198,0: wait 198,1 : print @tPlayer_x! : print @tPlayer_y!
tComputer_x! = 38 : tComputer_y! = 23 : print @tComputer_x! : print @tComputer_y!

tFuturePoint_x! = 0: tFuturePoint_y! = 0 : print @tFuturePoint_x! : print @tFuturePoint_y!
bMoveNow! = 0 : print @bMoveNow!

tVecComputerPlayer_Xdiff = 0 : tVecComputerPlayer_Ydiff = 0 : tVecComputerPlayer_XdiffABS = 0 : tVecComputerPlayer_YdiffABS = 0 : print @tVecComputerPlayer_Xdiff : print @tVecComputerPlayer_Ydiff : print @tVecComputerPlayer_XdiffABS : print @tVecComputerPlayer_YdiffABS
tVecWallToSimulator_Xdiff = 0 : tVecWallToSimulator_Ydiff = 0 : print @tVecWallToSimulator_Xdiff : print @tVecWallToSimulator_Ydiff
tVectorDir_X = 0 : tVectorDir_Y = 0 : print @tVectorDir_X : print @tVectorDir_Y
tWallVectorDir_X = 0 : tWallVectorDir_Y = 0 : print @tWallVectorDir_X : print @tWallVectorDir_Y
tWallPosition_Y! = 0 : print @tWallPosition_Y!
tWallPosition_X! = 0 : print @tWallPosition_X!
nBresenhamDiff = 0 : nCrossProduct = 0 : nThresholdCrProd = 0 : print @nBresenhamDiff : print @nCrossProduct : print @nThresholdCrProd
bLineMoreVertical! = 0 : print @bLineMoreVertical!

const MAXDIR! = 3
nDirectionScalar! = 0 : print @nDirectionScalar! : poke 198,0 : wait 198,1
'255 equivalent to -1!
data aDirections_Y![] = 255, 0, 1, 0 ' north, east, south, west
data aDirections_X![] = 0, 1, 0, 255 ' north, east, south, west
print @aDirections_Y![0] : print @aDirections_Y![1] : print @aDirections_Y![2] : print @aDirections_Y![3]
print @aDirections_X![0] : print @aDirections_X![1] : print @aDirections_X![2] : print @aDirections_X![3]

poke 198, 0: wait 198, 1

bWllFllwMode! = 0 : print @bWllFllwMode! ' dim bWllFllwMode! @$4200 :
bPledgeMode! = 0 : print @bPledgeMode! ' dim bPledgeMode! @$4201 :
nFastIndex! = 0 : print @nFastIndex! ' dim nFastIndex! @$4202 :
nSimulatorNumber! = 0 : print @nSimulatorNumber! ' dim nSimulatorNumber! @$4203 :
poke 198,0 : wait 198,1
...
for nIndexX! = 0 to 1
    for nIndexY! = 0 to 5
        print nIndexX! ; : print " " ; : print nIndexY! ; : print " " ; : print @aSimulators![nIndexX!, nIndexY!]
    next nIndexY!
next nIndexX!
poke 198,0 : wait 198,1
